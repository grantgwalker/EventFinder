        ...
        <div className="events-grid">
          {events.map((event) => (
            <div key={event.id} className="event-card">
              ...
              {(!activeFilters || (
                (activeFilters.price === "all" || event.price === activeFilters.price) &&
                (activeFilters.date === "all" || event.date === activeFilters.date) &&
                (activeFilters.category === "all" || event.category === activeFilters.category)
              )) && <EventCard {...event} />}
            </div>
          ))}
        </div>
